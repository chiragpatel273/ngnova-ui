...
| 3     | Checkbox     | Forms, indeterminate state         | In progress | Unknown        | In progress | Unknown | Unknown            | Unknown | Isolated secondary entry point | Output docs now match `focused`/`blurred`; full mixed-state and CVA audit remains.                                                                         |
| 4     | Radio        | Forms, grouped inputs              | In progress | Unknown        | In progress | Unknown | Unknown            | Unknown | Isolated secondary entry point | Output docs now match `focused`/`blurred`; keyboard, labeling, and CVA audit remains.                                                                      |
| 5     | Switch       | Forms, boolean state               | In progress | Unknown        | In progress | Unknown | Unknown            | Unknown | Isolated secondary entry point | Output docs now match `focused`/`blurred`; semantics and forms synchronization audit remains.                                                              |
| 6     | Select       | Forms, native select options       | In progress | Unknown        | In progress | Unknown | Unknown            | Unknown | Isolated secondary entry point | Output docs now match `focused`/`blurred`; placeholder, disabled-option, and CVA audit remains.                                                            |
...
| 12    | Card         | Layout and projection              | In progress | Unknown        | In progress | Unknown | Unknown            | Unknown | Isolated secondary entry point | Playground now uses the standard docs shell and shared responsive Preview/Code pattern; implementation, projection, and package audit remains.             |
