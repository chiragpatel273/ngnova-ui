...
| npm package metadata                             | Ready  | `projects/ui/package.json`, `dist/ui/package.json`, `npm.cmd run audit:package`     | Repository, license, keywords, exports, peer dependencies, public access, and packed metadata are verified; npm scope authentication remains an external publish step. |
