...
@Component({
  ...
  template: `
    ...
    >
      ...
      <section class="min-w-0 bg-slate-50/70 dark:bg-slate-950">
        <header
          class="flex min-h-14 items-center gap-2 border-b border-slate-200/80 bg-white px-4 dark:border-slate-800 dark:bg-slate-950"
        >
          <button
            type="button"
            uiButton
        ...
        <div class="space-y-4 p-3 sm:p-4">
          ...
          >
            <div>
              <p
                class="text-xs font-semibold uppercase tracking-[0.1em] text-blue-700 dark:text-blue-300"
              >
                Overview
              </p>
              <h1
              ...
              <p class="mt-1 text-xs text-slate-500 dark:text-slate-400">
                Here is what is happening across Acme Corporation today.
              </p>
            </div>
            <div class="flex items-center gap-2">
              <button type="button" uiButton variant="outline" size="sm">
            ...
            <ui-card padding="none" ariaLabel="Key metrics">
              <div class="grid gap-px bg-slate-200 sm:grid-cols-2 xl:grid-cols-4 dark:bg-slate-800">
                @for (metric of metrics; track metric.label) {
                  <article
                    data-admin-metric
                    class="min-w-0 bg-white p-3.5 dark:bg-slate-950"
          ...
          <ui-card padding="none" ariaLabel="Recent orders">
            ...
            <ui-table
              class="block [&_table]:!text-xs [&_td]:!px-3 [&_td]:!py-2 [&_th]:!px-3 [&_th]:!py-2"
