...
| 2     | Textarea     | Forms, CVA, counters               | Ready       | Ready          | Ready           | Ready   | Present in classes | Ready   | Isolated secondary entry point | Issue #3 audit aligned docs outputs with implementation and added CVA, validation, counter, ARIA, and styling coverage. |
