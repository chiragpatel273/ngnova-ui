...
<p aria-live="polite">
  {{ buttonFocused() ? 'Save action focused' : 'Ready to save' }}
      ...
      testing: [
        ...
        'Verify pressed emits only when enabled, loading prevents repeat activation, and focus changes remain observable.',
        'Cover accessible names for icon-only actions, disabled link behavior, and labels for grouped controls.',
      ],
    },
  ],
  [
...
/>`,
      ...
      testing: [
        ...
        'Test floating labels, intent classes, passwordVisibilityChange, word counters, and submitted output when the application uses those features.',
      ],
    },
  ],
  [
