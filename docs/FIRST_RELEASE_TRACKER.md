...
| ----- | ------------ | ---------------------------------- | ----------- | -------------- | --------------- | ----------- | ------------------ | ------------------------- | ------------------------------ | ------------------------------------------------------------- |
| 1     | Input        | Forms, CVA, validation, ARIA       | In progress | Under audit    | Under audit     | Under audit | Present in classes | Present, needs gap review | Isolated secondary entry point | First component audit started; package entry is now isolated. |
| 2     | Textarea     | Forms, CVA, counters               | Not started | Unknown        | Unknown         | Unknown     | Unknown            | Unknown                   | Isolated secondary entry point | Audit after Input.                                            |
...
| 7     | Button       | Actions, loading, forwarded events | Not started | Unknown        | Recently edited | Unknown     | Unknown            | Unknown                   | Isolated secondary entry point | Re-audit after forms.                                         |
