            ...
            @for (component of allComponents; track component.slug) {
              ...
              >
                <div class="flex items-start justify-between gap-4">
                  <div>
                    <span
                      class="rounded bg-blue-100 px-2 py-1 text-xs font-semibold uppercase text-blue-800 dark:bg-blue-950 dark:text-blue-200"
                    >
                  ...
                  <span
                    class="font-mono text-sm text-slate-400 transition group-hover:text-blue-800 dark:group-hover:text-blue-200"
                  >
                    {{ component.selector }}
                  </span>
                </div>
